...
```
    ...
    │       │       │       │       │       │
    ▼       ▼       ▼       ▼       ▼       ▼
  S09     S07     S08     S11    S14     S16
  Add     People  Groups  Bal.   Fund   Admin
  Expense   │               │             │
    │       │               │             │
    ▼       ▼               ▼             ▼
  S05     S06             S12           S10
  (back)  Invite          Settle        Expense
          Share           Up            Detail
...
| S06 | Invite/Join | Generate & share invite codes | S05 "Invite Link", admin actions |
| S07 | Manage People | Person list, identity resolution, PFG | S05 "People" |
| S08 | Manage Groups | Consumption + settlement groups | S05 "Groups" |
| S09 | Add Expense | Single-screen expense entry | S05 FAB |
...
| R04 Invitation | S05 → S06 ··· S01 → S02 → S05 | Admin (send) + invitee (receive) |
